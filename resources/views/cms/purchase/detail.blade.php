            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" x-model="detail.status" readonly />
                    </div>
                </div>
            </div>
            <div class="table-responsive">
                <x-new-header :isSearch="false" />
                ...
                Alpine.data('data', () => ({
                    ...
                    getAllData() {
                        ...
                        window.axios.get(url).then((response) => {
                            ...
                            this.detail = res
                            this.detail.status = status == 0 ? 'Menunggu Persetujuan' : status == 1 ? 'Disetujui' : 'Ditolak'
                            this.detail.user = res.user
