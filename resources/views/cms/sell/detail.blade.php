<x-layouts.app>
    ...
    <div class="card" x-data="data">
        <div class="card-header">
            ...
            <a href="{{ route('cms.sell') }}" class="btn btn-danger">
            ...
            document.addEventListener('alpine:init', () => {
                Alpine.data('data', () => ({
                    ...
                    update(id) {
                        ...
                        window.axios.get(`sells-detail/${id}`).then((response) => {
                    ...
                    save() {
                        let request
                        if (this.isUpdate) {
                            request = window.axios.put(`sells-detail/${this.form.id}`, this.form)
                        } else {
                            request = window.axios.post('sells-detail', this.form)
                        }
                    ...
                    delete(id) {
                        window.axios.delete('sells-detail/' + id).then((response) => {
                            this.getAllData()
                            window.Toast.fire({
                                icon: 'success',
                                title: response.data.message
